...
export default function Navbar() {
    ...
    const [bounds, setBounds] = useState({ left: -1000, right: 0, top: -1000, bottom: 0 });
    ...
    useEffect(() => {
        const updateBounds = () => {
            setBounds({
                ...
                right: 0,
                top: -window.innerHeight + 140, // Keeps it comfortably below the navbar
                bottom: 0
            });
        };
        updateBounds();
    ...
    const handleDragEnd = (_event: any, info: any) => {
        const snapToLeft = info.point.x < window.innerWidth / 2;
        controls.start({ x: snapToLeft ? bounds.left : 0 });
    };
    ...
    return (
        <>
            <nav className="navbar">
                <div className="nav-container">
                    ...
                    <div className="nav-right">
                        <a href="https://wa.me/919995008007" target="_blank" rel="noreferrer" className="nav-whatsapp desktop-whatsapp" aria-label="WhatsApp">
                        ...
                        <button className={`nav-mobile-btn ${isMobileMenuOpen ? 'open' : ''}`} onClick={() => setIsMobileMenuOpen(!isMobileMenuOpen)} aria-label="Toggle Menu">
            ...
            {/* Mobile floating WhatsApp button rendered outside navbar to avoid backdrop-filter rendering context */}
            <motion.a
            ...
            >
                <div className="floating-whatsapp-inner">
